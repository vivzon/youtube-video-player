<?php
    ...
    class Database{
    	...
    	private $db_user = "u605002174_ytplayer";       // Change as required
    	private $db_pass = "Admin@123$#";   // Change as required
    	private $db_name = "u605002174_ytplayer";   // Change as required
    	...
    	public function select($table, $rows = '*', $join = null, $where = null, $order = null, $limit = null, $group = null){
    		// Check to see if the table exists
        if($this->tableExists($table)){ 
